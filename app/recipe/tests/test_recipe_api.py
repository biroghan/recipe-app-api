...
def sample_tag(user, name='Main course'):
    """create and retuen a sample tag"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Thai vergerable curry')
        recipe2 = sample_recipe(user=self.user, title='Aubergine with tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Vegetraian')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Feata cheese')
